...
while True:
    ...
    #INFINITE LOOP, DON'T KNOW HOW TO STOP IT

    elif ready_to_play.lower() == "exit":
        break
...
# - Repeat 9 more times
           ...
           # print random.sample(rap_pair, 1) and return random.sample(rap_pair())        
            ...
            for key, value in rap_pair:
                print key
                guess = raw_input(">>> ")

            if guess.isdigit():
                print "I don't think I know what that means..."
...
#Don't allow duplicates in the random /shuffle option
# def nodupchoice():
